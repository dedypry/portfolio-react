...
export default function Experience() {
  return (
    <section id="experience" className="container-x py-28">
      <SectionHeader
        eyebrow="Experience"
        title="Six years, twelve stacks, one consistent goal: ship the right thing."
        description="A short timeline of where I've been — from full-stack freelancer to engineering lead — and the kinds of problems I've enjoyed solving along the way."
      />
      ...
      <ol className="relative">
        ...
        {experiences.map((exp, i) => (
          <Reveal as="li" key={exp.role + exp.period} delay={i * 0.04}>
            <div className="relative flex gap-5 pb-10 sm:gap-7">
              ...
              <div className="glass flex-1 rounded-2xl p-5 sm:p-6">
                ...
                <ul className="mt-4 space-y-2">
                  {exp.highlights.slice(0, 5).map((h, idx) => (
                    <li
                      key={idx}
