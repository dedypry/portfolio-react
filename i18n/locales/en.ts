...
export const en: TranslationShape = {
  ...
  chat: {
    ...
    online: "Online",
    greeting:
      "Hi there! I'm Dedy's AI assistant. Ask me about his experience, projects, stack, availability, or how to reach him.",
    suggestionLabel: "Try asking:",
    suggestions: [
      {
        label: "Background",
        prompt: "Give me a quick overview of Dedy's background.",
      },
      {
        label: "Best work",
        prompt: "What is Dedy's most impressive recent project and why?",
      },
      {
        label: "Tech stack",
        prompt: "What is Dedy's preferred tech stack and why?",
      },
      {
        label: "Hire him",
        prompt: "Is Dedy open to new opportunities? How do I reach him?",
      },
    ],
    inputPlaceholder: "Ask anything about Dedy…",
    send: "Send",
    stop: "Stop",
